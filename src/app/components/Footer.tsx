...
const Footer = () => {
  return (
    <footer className="bg-black text-white">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-black px-10 md:px-[135px] py-8 md:py-[50px]">
        ...
        <div className="flex mt-6 md:mt-0">
          <input
            ...
            className="bg-[#FF9F0D] text-whit py-2 px-4 md:py-3 md:px-6 rounded-l-md focus:outline-none "
          />
          ...
          <ul className="space-y-6">
            {[1, 2, 3].map((_, index) => (
              <li key={index} className="flex gap-4">
                <Image src="/assets/footer-1.png" alt="Post" width={80} height={80} />
                <div>
      ...
      <div className="bg-[#FF9F0D] py-6 px-4 md:flex md:justify-between md:items-center text-center md:text-left">
        <span className="text-sm text-gray-300">
        Copyright © 2022 Ayeman. All Rights Reserved.
        </span>
        <div className="flex justify-center md:justify-end gap-4 mt-4 md:mt-0 mr-[105px]">
